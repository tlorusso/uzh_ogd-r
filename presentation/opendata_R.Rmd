...
data <-data %>% 
  ...
  summarize(ja_anteil=sum(JA_STIMMEN_ABSOLUT,na.rm=T)/sum(JA_STIMMEN_ABSOLUT+NEIN_STIMMEN_ABSOLUT,na.rm=T)*100)

ggplot(data,aes(as.numeric(ja_anteil),VORLAGE_NAME))+
